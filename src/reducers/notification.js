import { NOTIFICAIONS_FAILURE, NOTIFICAIONS_REQUEST, NOTIFICAIONS_SUCCESS, NOTIFICAION_BY_ID_FAILURE, NOTIFICAION_BY_ID_REQUEST, NOTIFICAION_BY_ID_SUCCESS } from "../redux/ActionTypes";
const INITIAL_STATE = {
    loading: true,
    notifications: [],
    notification: [],
